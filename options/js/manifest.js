	...
	OPTIONS = {
		FORMS : {
			"options" : [
                ...
                {"name":"strip-query-params", "label":"Strip query params", "type":"checkbox", "value": "false", parent:'basicSettings' },
                {"name":"section-title-1", "label":"Section Title", "type":"text", "prePopulate": "Default", parent:'basicSettings', labelSelector: ".basicSettings .section__heading, a[href='#basicSettings']" },
                {"name":"section-title-2", "label":"Section Title", "type":"text", "prePopulate": "Additional Stack 1", parent:'secondarySettings2', labelSelector: ".secondarySettings2 .section__heading, a[href='#secondarySettings2']" },
                {"name":"section-title-3", "label":"Section Title", "type":"text", "prePopulate": "Additional Stack 3", parent:'secondarySettings3', labelSelector: ".secondarySettings3 .section__heading, a[href='#secondarySettings3']" },
                {"name":"section-title-4", "label":"Section Title", "type":"text", "prePopulate": "Additional Stack 4", parent:'secondarySettings4', labelSelector: ".secondarySettings4 .section__heading, a[href='#secondarySettings4']" },
                {"name":"section-title-5", "label":"Section Title", "type":"text", "prePopulate": "Additional Stack 5", parent:'secondarySettings5', labelSelector: ".secondarySettings5 .section__heading, a[href='#secondarySettings5']" },
                {"name":"section-title-6", "label":"Section Title", "type":"text", "prePopulate": "Additional Stack 6", parent:'secondarySettings6', labelSelector: ".secondarySettings6 .section__heading, a[href='#secondarySettings6']" },
                {"name":"key-value-pair-domain", "id":"key-value-pair-domain", "label":"", "type" : "key-value", tag:"div", parent:'basicSettings', prePopulate: AEMPRESET, data : [{cols:[{"title":"URL Match"},{"title":"URL Replace"}]}]},
