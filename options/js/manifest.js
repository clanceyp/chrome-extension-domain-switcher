...
var DEBUG = true,
    ...
    ADMINSYSTEM = '[{"key":"http://localhost:4502.*","value":"System console||http://localhost:4502/system/console/bundles"},{"key":"ignore","value":"Package Manager||http://localhost:4502/crx/packmgr/index.jsp"},{"key":"ignore","value":"Admin Home||http://localhost:4502/aem/start.html"},{"key":"ignore","value":"Replication||http://localhost:4502/etc/replication.html"},{"key":"ignore","value":"Groovy console||http://localhost:4502/groovyconsole"}]',
